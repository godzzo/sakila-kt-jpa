...
class CityController(
    ...
    @RequestMapping(value = ["/{repository}/extendCities"], method = arrayOf(RequestMethod.GET))
    fun extendCities(pageable: Pageable,
    ...
    @RequestMapping(value = ["/{repository}/extendCitiesPage"], method = arrayOf(RequestMethod.GET))
    fun extendCitiesPage(pageable: Pageable,
                         assembler: PagedResourcesAssembler<City>) : ResponseEntity<PagedModel<EntityModel<City>>> {

        log.info("CityController - extendCitiesPage - CALLED!!!");
        ...
        return ResponseEntity(assembler.toModel(persons), HttpStatus.OK);
    }
